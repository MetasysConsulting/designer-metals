...
export default function SalesOverview() {
  ...
  useEffect(() => {
    ...
    console.log('Sales Overview - Loading saved filters:', savedFilters)
    setFilters(savedFilters)
  }, [])

  const handleFiltersChange = useCallback((newFilters: any) => {
    console.log('Sales Overview - Filters updated:', newFilters)
  ...
  return (
    <>
      ...
      <DashboardHeader pageName="Sales Overview" onFiltersChange={handleFiltersChange} />
